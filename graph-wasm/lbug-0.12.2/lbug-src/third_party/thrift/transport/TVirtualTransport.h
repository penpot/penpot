...
#ifndef _LBUG_THRIFT_TRANSPORT_TVIRTUALTRANSPORT_H_
#define _LBUG_THRIFT_TRANSPORT_TVIRTUALTRANSPORT_H_ 1
...
#endif // #ifndef _LBUG_THRIFT_TRANSPORT_TVIRTUALTRANSPORT_H_
