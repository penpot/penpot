...
#ifndef _LBUG_THRIFT_PROTOCOL_TVIRTUALPROTOCOL_H_
#define _LBUG_THRIFT_PROTOCOL_TVIRTUALPROTOCOL_H_ 1
...
#endif // #define _LBUG_THRIFT_PROTOCOL_TVIRTUALPROTOCOL_H_ 1
