...
private:
    ...
    lbug::regex::Regexp* entire_regexp_; // parsed regular expression
    lbug::regex::Regexp* suffix_regexp_; // parsed regular expression, prefix_ removed
...
using lbug::regex::LazyRE2;
using lbug::regex::RE2;
