use skia_safe::{self as skia, textlayout::PositionWithAffinity};
...
impl TextPosition {
    ...
    pub fn set(&mut self, node: Option<TextNode>, offset: i32) {
        self.node = node;
        self.offset = offset;
    }
}
...
impl TextSelection {
    ...
    pub fn set_focus(&mut self, node: Option<TextNode>, offset: i32) {
        self.focus.set(node, offset);
    }

    pub fn set_anchor(&mut self, node: Option<TextNode>, offset: i32) {
