...
use crate::shapes::{Corners, Fill, Shadow, Shape, SolidColor, StructureEntry, Type};
...
pub(crate) struct RenderState {
    ...
    // Map to track accumulated children rects for each node during tree traversal
    pub accumulated_children: HashMap<Uuid, Rect>,
...
impl RenderState {
    pub fn new(width: i32, height: i32) -> RenderState {
        ...
        RenderState {
            ...
            accumulated_children: HashMap::new(),
            show_grid: None,
    ...
    pub fn render_shape(
        ...
        if let Some(nested_shadows) = self.nested_shadows.last() {
            shape.to_mut().shadows.extend(nested_shadows.clone());
        }
