...
use skia_safe::{Canvas, Color, Matrix, Paint, BlendMode, Rect};
...
fn render_cursor(canvas: &Canvas, editor_state: &TextEditorState, text_content: &TextContent, shape: &Shape) {
