...
class TextEditorPlayground {
  ...
  constructor(module, canvas) {
    ...
    this.#ui = {
      ...
      positionXElement: document.getElementById("position-x"),
      positionYElement: document.getElementById("position-y"),
  ...
  #onWheel = (e) => {
    ...
    this.#textEditor.updatePositionWithTransform({
      x: this.#viewport.x,
      y: this.#viewport.y,
      rotation: 0,
  ...
  #setupCanvasContext() {
    ...
    this.#resizeCanvas();
    this.#module.call("init", canvas.width, canvas.height);
  ...
  #setupUI() {
    ...
    this.#ui.textAlignLeftElement.addEventListener("change", this.#onTextAlignChange);
    this.#ui.textAlignCenterElement.addEventListener("change", this.#onTextAlignChange);
    this.#ui.textAlignRightElement.addEventListener("change", this.#onTextAlignChange);
    this.#ui.textAlignJustifyElement.addEventListener("change", this.#onTextAlignChange);

    this.#ui.fontFamilyElement.addEventListener("change", this.#onFontFamilyChange);
    this.#ui.fontWeightElement.addEventListener("change", this.#onFontWeightChange);
    this.#ui.fontSizeElement.addEventListener("change", this.#onFontSizeChange);
    this.#ui.fontStyleElement.addEventListener("change", this.#onFontStyleChange);
    this.#ui.lineHeightElement.addEventListener("change", this.#onLineHeightChange);
  ...
  #setupShapes() {
    const textShape = new Shape({
      ...
      textContent: TextContent.fromDOM(this.#textEditor.root, this.#fontManager),
    });
  ...
  #onNeedsLayout = (e) => {
    ...
    textShape.textContent.updateFromDOM(this.#textEditor.root, this.#fontManager);
    this.#setShape(textShape);
    this.render();
  };
