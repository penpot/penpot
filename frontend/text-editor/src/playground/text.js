...
export class TextLeaf {
  ...
  static fromDOM(leafElement, fontManager) {
    const fontSize = parseFloat(
      leafElement.style.getPropertyValue("font-size"),
    );
    const fontStyle =
      FontStyle.fromStyle(leafElement.style.getPropertyValue("font-style")) ??
      FontStyle.NORMAL;
    const fontWeight = parseInt(
      leafElement.style.getPropertyValue("font-weight"),
    );
    const letterSpacing = parseFloat(
      leafElement.style.getPropertyValue("letter-spacing"),
    );
    const fontStyles = fontManager.fonts.get(
      leafElement.style.getPropertyValue("font-family"),
    );
    const textDecoration = TextDecoration.fromStyle(
      leafElement.style.getPropertyValue("text-decoration"),
    );
    const textTransform = TextTransform.fromStyle(
      leafElement.style.getPropertyValue("text-transform"),
    );
    const textDirection = TextDirection.fromStyle(
      leafElement.style.getPropertyValue("text-direction"),
    );
