...
- **plugin-types:** Added optional per-side stroke state (`strokePerSide`, `strokeWidthTop`, `strokeWidthRight`, `strokeWidthBottom`, `strokeWidthLeft`) to the `Stroke` interface for boards and rectangles. Related to #11804.
