...
import { isColorFill, isLinearGradient, isRadialGradient, isAngularGradient } from '../../../lib/renderer/api/constants'
import { MAX_GRADIENT_STOPS } from '../../../lib/renderer/api/constants'
