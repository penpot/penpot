...
export function FloatingFillEditorPanel() {
  const { activeFillIndex, activeFill, anchorY, closeEditor, onChangeRef } = useFillEditor()
  ...
  // Reset position when a new fill editor opens
  useEffect(() => {
    setPos(null)
  }, [activeFillIndex])
  ...
  useEffect(() => {
    if (activeFillIndex === null) return
  ...
  if (activeFillIndex === null || !activeFill) return null
